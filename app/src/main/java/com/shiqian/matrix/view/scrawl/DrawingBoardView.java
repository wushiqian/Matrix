package com.shiqian.matrix.view.scrawl;
...
import static com.shiqian.matrix.view.scrawl.DrawAttribute.DrawStatus.PEN_WATER;
...
public class DrawingBoardView extends View
{
	...
	/** 绘画类型 **/
	private DrawAttribute.DrawStatus mDrawStatus = PEN_WATER;

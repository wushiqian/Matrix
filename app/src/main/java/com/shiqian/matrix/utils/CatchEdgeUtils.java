...
public class CatchEdgeUtils {
    ...
    public static CropWindowEdgeSelector getPressedHandle(float x,
        ...
        } else if (CatchEdgeUtils.isInHorizontalTargetZone(x, y, left, right, bottom, targetRadius)) {
            return CropWindowEdgeSelector.BOTTOM;//说明手指在裁剪框bottom区域
        } else if (CatchEdgeUtils.isInVerticalTargetZone(x, y, left, top, bottom, targetRadius)) {
